                                   ...
                                   tabPanel("Coral Bleaching", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Visulaizing the spatially extent of coral bleaching is critical for researchers as they can quickly see a snap shot of the entire reefs health. When a coral becomes stressed (increased SST, nutrient loading, etc) the coral will exude thier colorful photosynthetic symbiont, leading to a bleached white color.  The local community of Moorea can now see where decreasing fishing pressure could be benifical to the long term health of their reefs.  "),
                                                           p("Here is the link to download this", 
                                   ...
                                   tabPanel("Mean Coral Cover", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Tracking the amount of coral found on the reef is invaluable to researchers as tracking the amount of corals can be directly related to the health of the reef. Coral cover is important for researchers as knowing the amount of free and occupied space by corals can give researchers insight into the health of the reef. The three coral genera we visualized seperately are important Sclerctinian reef building corals, and some of the more common corals found."),
                                   ...
                                   tabPanel("Mean Fish Biomass", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Herbivore fish biomass is important to a researcher because if herbivore densities are at a high enough threshold they can then suppress algae populations leading to the persistence of corals."),
                                   ...
                                   tabPanel("Crown of Thorns Density", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("COTS density is important to a researcher because they are a corilivore, meaning they eat coral, and if their populations are left unchecked they can consume all the corals on a reef leading to the coral reef collapsing. 
"),
