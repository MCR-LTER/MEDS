                                   ...
                                   tabPanel("Percent Nitrogen", 
                                            sidebarLayout(
                                              sidebarPanel(width = 6, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Knowing the levels of nitrogen through out the lagoon will help researchers identify locations on the reef that may be prone to macroalgae over growth, possible coral bleaching, and increased transmission of coral diseases. Areas with consistently high levels of nitrogen can be managed more rigorously."),
                                   ...
                                   tabPanel("Coral Bleaching", 
                                            sidebarLayout(
                                              sidebarPanel(width = 6, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Visulaizing the spatial extent of coral bleaching is critical for researchers as they can quickly see a snap shot of the entire reefs health. When a coral becomes stressed (increased SST, nutrient loading, etc) the coral will exude thier colorful photosynthetic symbiont, leading to a bleached white color. The local community of Moorea can now see where decreasing herbivore fishing pressure and nutrient run off could potentially be benifical for the long term health of their reefs.  "),
                                                           p("Here is the link to download this", 
                                   ...
                                   tabPanel("Predicted Sewage", 
                                            sidebarLayout(
                                              sidebarPanel(width = 6, 
                                                           ...
                                                           h3("Importance"),
                                                           p("Sewage run-off can lead to nutrient loading which can cause macroalgae over growth, possible coral bleaching, and increased transmission of coral diseases for the Moorea Lagoon. Identifing locations of high potentially high human sewage input could lead to developing mitigation plans to reduce the amount of human sewage entering the Moorea Lagoon.")),
                                   ...
                                   tabPanel("Mean Coral Cover", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           h3("Background"), 
                                                           p("This dataset contains the percentage cover of the stony corals (Scleractinia) and other major groups analyzed from 0.5 x 0.5 m photographic quadrats in several reef habitats at the Moorea Coral Reef LTER, French Polynesia. This survey has been repeated annually in April since 2005. Functional groups (i.e., dependent variables) counted are: Scleractinian Corals (by genus where appropriate, see methods), Macroalgae, Crustose Coralline Algae / Bare Space, Soft Corals, Hydrocorals (Millepora), Algal Turf and Sand. For the purposes of this app, Scleractinian Corals included Porities, Acropora, Pocillopora and all other functional groups were not included in the temporal figures created for coral cover. The coral community was sampled photographically in all habitats surrounding the island: Fringing Reef, Lagoon (Backreef), and Outer Reef (Forereef.) Figures were further broken down to show individual trends of three specific Scleractinian genera of coral, Porities, Acropora, Pocillopora."),
                                                           ...
                                                           h3("Importance"), 
                                                           p("Tracking the amount of coral found on the reef is invaluable to researchers as knowing the abundance of corals can be directly related to the health of the reef. The three additional coral genera we visualized seperately are important Sclerctinian reef building corals, and some of the more common corals found."),
                                   ...
                                   tabPanel("Mean Fish Biomass", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Herbivore fish biomass is important to a researcher because if herbivore densities are at a high enough threshold they can suppress algae populations leading to the persistence of corals. Many coral reefs near human populations lack proper levels of herbivore fish biomasses due to fishing pressures which has lead to the collapse of coral reefs because macroalgae over groth."),
                                   ...
                                   tabPanel("Crown of Thorns Density", 
                                            sidebarLayout(
                                              sidebarPanel(width = 5, 
                                                           ...
                                                           h3("Importance"), 
                                                           p("Crown of Thorns Density is important to a researcher because they are a corilivore, meaning they eat coral, and if their populations are left unchecked they will voraciously consume all the corals on a reef leading to the coral reef collapsing. 
"),
